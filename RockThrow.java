/**
 * The RockThrow class. Implements the interface ThrowTypes. Stores all the information 
...
public class RockThrow implements ThrowTypes{
	public RockThrow(int xStartIn, int yStartIn, int xVelocityIn, int yVelocityIn) {
		xCoord = xStartIn;
		yCoord = yStartIn;
	...
	private final String THROW_NAME = "rock";
	private final String FONT_NAME = "Impact";
